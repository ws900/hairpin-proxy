...
```shell
kubectl apply -f https://raw.githubusercontent.com/ws900/hairpin-proxy/v0.2.1/deploy.yml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/ws900/hairpin-proxy/v0.2.1/deploy-etchosts-daemonset.yml
```
